...
<div class="form_container">
	...
	<h2 class="text-center" id="title">Nouveau client</h2>
	...
	<div class="mb-2">
					...
					<div class="mb-2">
						<label  class="form-label mb-0">Type de BP</label>
						<input type="number" name="txtBP" id="txtBP" placeholder="en MB" class="form-control" required>
					</div>
					<div class="mb-2">
	...
	<p><i class="fa-regular fa-question"></i>Voulez-vous vraiment supprimer le client?</p>	
