...
<body>
	<?php 
require"scripts/home/articles_script.php";
	 ?>
...
<div class="topbar">
	...
	<form method="POST" class="searchbar">
		<input type="text" name="txtSearch" placeholder="chercher par nom">
...
<div class="bottom">
<div class="header">
	<h3>Les articles enregistres</h3>
...
<div class="tablecontainer">
	<div class="tableheader">
		<label style="width:33%">Id</label>
		<label>Nom</label>
		<label style="text-align:right;width: 40%;">Options</label>
	</div>
	<div class="tablebody" id="tablebody">
		<table width="100%" id="table">
	<tbody>
		<?php if ($articlerows!=0) { ?>
...
<?php 
require"home_cuts/popups/article_popup.php";
 ?>
<?php 
