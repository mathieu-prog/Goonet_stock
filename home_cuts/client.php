...
<body>
	<?php 
require"scripts/home/client_script.php";
	 ?>
...
<div class="topbar">
	...
	<form method="POST" class="searchbar">
		<input type="text" name="txtSearch" placeholder="chercher par nom ou prenom">
...
<?php 
require"home_cuts/popups/client_popup.php";
 ?>
<?php 
...
$(document).on('click','.editbutton button', function(event) {
   ...
   var rowindex=$(this).closest('tr').index();
    ...
    var txtBP=document.getElementById("txtBP");
    var btAdd=document.getElementById("btAdd");
    ...
    txtAdresse.value=table.rows[rowindex].cells[6].innerHTML;
     txtBP.value=table.rows[rowindex].cells[7].innerHTML;
 	title.innerHTML="Modification d'un client";
